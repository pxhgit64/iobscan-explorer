        ...
        <div class="block_list_header_content">
          ...
          <div class="block_list_pagination_content">
            ...
            >
              ...
              <el-table-column
                class-name="address"
                v-if="productionConfig.blockList.proposer"
                ...
                <template slot-scope="scope">
                  ...
                  >
                    <router-link
                      ...
                      :to="`/staking/${scope.row.proposerAddress}`"
                      >{{ scope.row.proposerValue }}</router-link
                    >
                  </span>
                  <span
                    v-if="
              ...
              <el-table-column
                :min-width="ColumnMinWidth.txn"
                prop="numTxs"
                :label="$t('ExplorerLang.table.transactions')"
              ></el-table-column>
              ...
              ></el-table-column>
              <el-table-column
                :min-width="ColumnMinWidth.blockAge"
                prop="ageTime"
                :label="$t('ExplorerLang.table.age')"
              ></el-table-column>
            </el-table>
          </div>
          <div class="pagination_content">
